...
const Slide:React.FC<propsType> = ({img,title,mainTitle,price}) => {
  return (
    <div className='outline-none border-none relative'>
        ...
        -translate-y-[50%] space-y-2 lg:space-y-4 bg-[#ffffffa2]
        sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none">
            <h3 className='text-green-500 text-[24px] lg-text-[28px]  '>{title}</h3>
            <h2 className='text-black text-[26px] md:text-[30px] lg:text-[44px] font-blod leading-[1.2]'>
              {mainTitle}
            </h2>
            ...
            <div >
              <button className='bg-yellow-400 text-white text-[12px]  p-3 px-4 rounded-lg hover:bg-slate-400 '>
              Shop Now
              </button>
             ...
             <Image className='w-[100%] h-[300px] md:h-auto rounded-xl object-cover object-right md:object-left-bottom'
              src={img} alt="bann" width={2000} height={2000} />
